...
func (m HelloRequest) JavaClassName() string {
	return "com.ikurento.user.HelloRequest"
}

func (m HelloReply) JavaClassName() string {
	return "com.ikurento.user.HelloReply"
}

func init() {
	impl.RegisterMessage(&HelloRequest{})
	impl.RegisterMessage(&HelloReply{})
}